...
public class WeeklySchedule
{
  ...
  public Schedule addDay(boolean aIsHoliday, boolean aIsBreakDay, Date aStartTime, Date aEndTime)
  {
    ...
    {
      return new Schedule(aIsHoliday, aIsBreakDay, aStartTime, aEndTime, this);
    }
  }
