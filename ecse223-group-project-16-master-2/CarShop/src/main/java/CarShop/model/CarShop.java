...
public class CarShop
{
  ...
  public CarShop(Date aDate, String aGeneralInfo, String aAddress, String aEmailAddress, String aPhoneNUmber, String aUsernameForOwner, String aPasswordForOwner, boolean aIsLoggedInForOwner, User aUserForOwner)
  {
    date = aDate;
    generalInfo = aGeneralInfo;
    address = aAddress;
    emailAddress = aEmailAddress;
    phoneNUmber = aPhoneNUmber;
    owner = new Owner(aUsernameForOwner, aPasswordForOwner, aIsLoggedInForOwner, aUserForOwner, this);
    services = new ArrayList<Service>();
  }
  ...
  public Service addService(String aName, double aDurationInHours, Garage aWorkingGarage, Owner aOwner)
  {
    return new Service(aName, aDurationInHours, aWorkingGarage, this, aOwner);
  }
