...
#
  #Background: 
    #Given a Carshop system exists #done
    #Given the system's time and date is "2021-02-01+09:00"#done
    #Given an owner account exists in the system #done
    #Given a business exists in the system #done by jerry
    #Given the following customers exist in the system: #done
      #| username  | password |
      #| customer1 | 12345678 |
      #| customer2 | 12345678 |
      #| customer3 | 12345678 |
    #Given the following technicians exist in the system: #done by jerry
    ...
    #Given each technician has their own garage #done by jerry
    #Given the following services exist in the system: #done by jerry
    ...
    #Given the following service combos exist in the system: #gonna be done by jerry
    ...
    #Given the business has the following opening hours #done
      ...
      #| Thursday  | 9:00      | 17:00   |
      #| Friday    | 9:00      | 15:00   |
    #Given all garages has the following opening hours #done
      #| day       | startTime | endTime |
      #| Monday    | 9:00      | 16:00   |
      #| Tuesday   | 9:00      | 16:00   |
      #| Wednesday | 9:00      | 16:00   |
      #| Thursday  | 9:00      | 16:00   |
    #Given the business has the following holidays #idk whats wrong
      #| startDate  | endDate    | startTime | endTime |
      #| 2021-02-25 | 2021-03-07 | 0:00      | 23:59   |
    #Given the following appointments exist in the system: #blocked on
...
#
  #Scenario Outline: A customer attempts to make various invalid appointments for services
    #Given "customer1" is logged in to their account#done
    #When "customer1" schedules an appointment on "<date>" for "<serviceName>" at "<startTime>"
