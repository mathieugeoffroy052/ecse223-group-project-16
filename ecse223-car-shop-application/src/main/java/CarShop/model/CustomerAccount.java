...
public class CustomerAccount extends UserAccount
{
  ...
  public CustomerAccount(String aUsername, String aPassword, boolean aIsLoggedIn, String aWarningMessage, User aUser)
  {
  ...
  public AppointmentInfo addAppointmentInfo(boolean aCustomerCanCancel, int aDaysBeforeAppt, TimeSlot aTimeSlot)
  {
    return new AppointmentInfo(aCustomerCanCancel, aDaysBeforeAppt, this, aTimeSlot);
  }
