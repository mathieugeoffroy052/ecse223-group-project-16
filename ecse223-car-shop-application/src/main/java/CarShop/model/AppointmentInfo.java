...
public class AppointmentInfo
{
  ...
  private boolean customerCanCancel;
  ...
  public AppointmentInfo(boolean aCustomerCanCancel, int aDaysBeforeAppt, CustomerAccount aCustomerAccount, TimeSlot aTimeSlot)
  {
    cachedHashCode = -1;
    canSetCustomerAccount = true;
    canSetTimeSlot = true;
    customerCanCancel = aCustomerCanCancel;
  ...
  public AppointmentInfo(boolean aCustomerCanCancel, int aDaysBeforeAppt, CustomerAccount aCustomerAccount, Date aStartTimeForTimeSlot, Date aEndTimeForTimeSlot, int aDaysBeforeAppointmentForTimeSlot, Service aCurrentServiceForTimeSlot, TechnicianDailySchedule aTechnicianDailyScheduleForTimeSlot)
  {
    customerCanCancel = aCustomerCanCancel;
    daysBeforeAppt = aDaysBeforeAppt;
    boolean didAddCustomerAccount = setCustomerAccount(aCustomerAccount);
    ...
    timeSlot = new TimeSlot(aStartTimeForTimeSlot, aEndTimeForTimeSlot, aDaysBeforeAppointmentForTimeSlot, aCurrentServiceForTimeSlot, aTechnicianDailyScheduleForTimeSlot, this);
  }
  ...
  public boolean setCustomerCanCancel(boolean aCustomerCanCancel)
  {
  ...
  public boolean getCustomerCanCancel()
  {
    return customerCanCancel;
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            "customerCanCancel" + ":" + getCustomerCanCancel()+ "," +
