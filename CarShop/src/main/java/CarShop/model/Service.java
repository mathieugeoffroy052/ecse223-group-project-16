...
public class Service
{
  ...
  public enum WorkType { Tires, Engine, Transmission, Electronics, Fluids }
  ...
  //Service Attributes
  private String name;
  private WorkType generalService;
  ...
  public Service(String aName, WorkType aGeneralService, double aDurationInHours, Garage aWorkingGarage, CarShop aCarShop)
  {
    ...
    generalService = aGeneralService;
  ...
  public boolean setGeneralService(WorkType aGeneralService)
  {
    boolean wasSet = false;
    generalService = aGeneralService;
    wasSet = true;
  ...
  public WorkType getGeneralService()
  {
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "generalService" + "=" + (getGeneralService() != null ? !getGeneralService().equals(this)  ? getGeneralService().toString().replaceAll("  ","    ") : "this" : "null") + System.getProperties().getProperty("line.separator") +
